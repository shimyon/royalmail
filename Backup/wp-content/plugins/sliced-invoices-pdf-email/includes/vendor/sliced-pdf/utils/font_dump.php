...
$cw = file_get_contents(_SLICED_MPDF_TTFONTDATAPATH.$font.'.cw.dat');
if (!$cw) { die("Error - Must be able to read font metrics file: "._SLICED_MPDF_TTFONTDATAPATH.$font.'.cw.dat'); }
$counter=0;


include(_SLICED_MPDF_TTFONTDATAPATH.$font.'.mtx.php');
