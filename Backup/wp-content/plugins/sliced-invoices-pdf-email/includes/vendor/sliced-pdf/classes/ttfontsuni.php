...
*/
			...
			if ($s) file_put_contents(_SLICED_MPDF_TTFONTDATAPATH.$this->fontkey.'.GSUBGPOStables.dat', $s);
...
?>';
			...
			file_put_contents(_SLICED_MPDF_TTFONTDATAPATH.$this->fontkey.'.GDEFdata.php', $s);
...
?>';
			...
			file_put_contents(_SLICED_MPDF_TTFONTDATAPATH.$this->fontkey.'.GSUBdata.php', $s);
...
$pstf = '.var_export($pstf , true).';
 ...
 '."\n".'?>';
						...
						file_put_contents(_SLICED_MPDF_TTFONTDATAPATH.$this->fontkey.'.GSUB.'.$st.'.'.$t.'.php', $s);
...
?>';
			...
			file_put_contents(_SLICED_MPDF_TTFONTDATAPATH.$this->fontkey.'.GPOSdata.php', $s);
