...
class Sliced_CGIFFILEHEADER
{
	...
	function load($lpData, &$hdrLen)
	{
		...
		if($this->m_bGlobalClr) {
			$this->m_colorTable = new Sliced_CGIFCOLORTABLE();
...
class Sliced_CGIFIMAGE
{
	...
	function __construct()
	{
		...
		unSet($this->m_lpComm);
		unSet($this->m_data);
		$this->m_gih = new Sliced_CGIFIMAGEHEADER();
		$this->m_lzw = new Sliced_CGIFLZW();
	}
...
class Sliced_CGIF
{
	...
	function __construct()
	{
		$this->m_gfh     = new Sliced_CGIFFILEHEADER();
		$this->m_img     = new Sliced_CGIFIMAGE();
		$this->m_lpData  = "";
