...
class Sliced_Public {
	...
	public function output_styles() {
		...
		wp_register_style( 'sliced-invoices_style_custom', plugins_url( $this->plugin_name ).'/public/css/custom_invoice.css', array(), $this->version, 'all' );
		...
		wp_print_styles( 
			array( 
				'sliced-invoices_open-sans', 
				'sliced-invoices_fontawesome', 
				'sliced-invoices_bootstrap', 
				'sliced-invoices_style',
				'sliced-invoices_style_custom' 
			) 
		);
