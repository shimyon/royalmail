...
class Sliced_Admin {
    ...
    */
	...
	public static function get_pre_defined_items() {
		...
		$set_items = "<select name='_sliced_items[0][pre_def]' id='_sliced_items_0_pre_def' class='pre_defined_products'>" . implode( "", $price_array ) . "</select>";
	 ...
	 * Get the vehicle type line items dropdown
	...
	public static function get_vehicle_type_items() {
		...
		// }
		$vehicle_type = isset( $general['vehicle_type'] ) ? $general['vehicle_type'] : '';
        ...
        return apply_filters( 'sliced_register_get_vehicle_type_items', $veh_array );
	}

	/**

	 * Get the brand type line items dropdown
	...
	public static function get_brand_type_items() {
		...
		//   echo "$key is at $value";
		// }
		$vehicle_type = isset( $general['brand_type'] ) ? $general['brand_type'] : '';
		...
		// $price_array[] = "<option value=''>" . __( 'Select Brand Type', 'sliced-invoices' ) . "</option>";
		/*
		...
		// $set_items = "<select name='brand_type_products' class='brand_type_products'>" . implode( "", $price_array ) . "</select>";
		// return $set_items;
	...
	public static function get_year_of_make_items() {
		...
		//   echo "$key is at $value";
		// }
		$year_of_make = isset( $general['year_of_make'] ) ? $general['year_of_make'] : '';
		...
		return $year_of_make_array;

	}


	public static function get_color_items() {
		...
		//   echo "$key is at $value";
		// }
		$color = isset( $general['color'] ) ? $general['color'] : '';
