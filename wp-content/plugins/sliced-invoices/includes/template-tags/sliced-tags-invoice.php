...
if ( ! function_exists( 'sliced_get_invoice_currency' ) ) :
	...
	function sliced_get_invoice_currency( $id = 0 ) {
		...
		$currency = apply_filters( 'sliced_get_invoice_currency', $output, $id );
...
if ( ! function_exists( 'sliced_get_invoice_specification' ) ) :



	function sliced_get_invoice_specification( $id = 0 ) {

		$output = Sliced_Invoice::get_specification( $id );

		return apply_filters( 'sliced_get_invoice_specification', $output, $id );
...
if ( ! function_exists( 'sliced_get_invoice_currency' ) ) :
	...
	function sliced_get_invoice_currency( $id = 0 ) {
		...
		$output = Sliced_Invoice::get_currency( $id );
