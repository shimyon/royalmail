...
if ( ! function_exists( 'sliced_get_the_termofshipping' ) ) :



	function sliced_get_the_termofshipping( $id = 0 ) {

		$output = Sliced_Quote::get_the_termofshipping( $id );

		return apply_filters( 'sliced_get_the_termofshipping', $output, $id );
...
if ( ! function_exists( 'sliced_get_invoice_terms_quote' ) ) :



	function sliced_get_invoice_terms_quote( $id = 0 ) {

		$output = Sliced_Quote::get_terms( $id );

		return apply_filters( 'sliced_get_invoice_terms_quote', $output, $id );
...
if ( ! function_exists( 'sliced_get_chk_addition_display_after_item' ) ) :



	function sliced_get_chk_addition_display_after_item( $id = 0 ) {

		$output = Sliced_Quote::get_chk_addition_display_after_item( $id );

		return apply_filters( 'sliced_get_chk_addition_display_after_item', $output, $id );
