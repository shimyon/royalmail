...
if ( ! function_exists( 'sliced_get_vehicle_type_items' ) ) :
	...
	function sliced_get_vehicle_type_items() {
...
if ( ! function_exists( 'sliced_get_brand_type_items' ) ) :

	function sliced_get_brand_type_items() {
		// $output = Sliced_Admin::get_brand_type_items();
		// echo apply_filters( 'sliced_get_brand_type_items', $output );

		$output = Sliced_Admin::get_brand_type_items();
		return apply_filters( 'sliced_get_brand_type_items', $output );
	}

endif;

if ( ! function_exists( 'sliced_get_year_of_make_items' ) ) :

	function sliced_get_year_of_make_items() {
		// $output = Sliced_Admin::get_brand_type_items();
		// echo apply_filters( 'sliced_get_brand_type_items', $output );

		$output = Sliced_Admin::get_year_of_make_items();
		return apply_filters( 'sliced_get_year_of_make_items', $output );
	}

endif;

if ( ! function_exists( 'sliced_get_color_items' ) ) :

	function sliced_get_color_items() {
		// $output = Sliced_Admin::get_brand_type_items();
		// echo apply_filters( 'sliced_get_brand_type_items', $output );

		$output = Sliced_Admin::get_color_items();
		return apply_filters( 'sliced_get_color_items', $output );
	}
